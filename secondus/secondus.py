...
to get the current sets in standard. The program is also future proof, which was a majority 
struggles I had with the project. 
"""
...
def get_legal_sets():
	...
	object_list.remove('Autumn 2019\n')
	break_index = object_list.index("Autumn 2020\n")
	object_list = object_list[0:break_index-3]
