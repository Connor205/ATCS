...
sfcrime = pd.read_csv("SF-police-data-2016.csv")
...
sfcrime_districts = pd.concat( [crime_distcat, sfdistricts], axis=1, sort=True)
...
#sfcrime_districts.plot(kind='scatter', y='Total', x='Density')
#plt.show()
...
#print( sfcrime['Descript'].value_counts())

#print( sfcrime[ sfcrime['Descript'].str.contains("DEATH") ]['Descript'].value_counts() )

# print( sfcrime[ sfcrime['Descript'].str.contains("MURDER") ])
